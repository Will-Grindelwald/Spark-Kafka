...
/****
 * 实现Kafka与Spark Streaming集成，最终数据用于实时可视化： 
 * 1.数据从kafka流入 
 * 2.SparkStreaming处理 
 * 3.数据输出到redis的 "messages"频道，用于实时可视化
 */
public class KafkaSparkStreaming {
	...
	public static void main(String[] args) {
		...
		// 通过Direct方式创建Dstream
		JavaPairDStream<String, String> kafkaPairDStream = KafkaUtils.createDirectStream(jssc, String.class,
			String.class, StringDecoder.class, StringDecoder.class, kafkaParam, topicSet);
